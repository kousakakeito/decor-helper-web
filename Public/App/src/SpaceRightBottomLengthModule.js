...
if(check[0].checked){
  ...
  const  rightBottomCheckTriangle  = require('src/SpaceRightBottomCheckTriangleModule');
  ...
  const  rightBottomCheckSquare  = require('src/SpaceRightBottomCheckSquareModule');
