...
module.exports = function handleClick(stage,dots,rectangle,isMouseOnBorder,layer,dashedLine,drawDashedLine,midRect,spacecenterInner,handleClick2){
  ...
  if( dots.filter(dot => dot.y() === rectangle.y()).length === 2 ||
      ...
      dots.filter(dot => dot.x() === rectangle.x()).length === 2 ) {
        ...
        const sideTopRightPoints  = require('src/SpaceSideTopRightPointsModule');
        ...
        const sideTopLeftPoints  = require('src/SpaceSideTopLeftPointsModule');
        ...
        const sideBottomRightPoints  = require('src/SpaceSideBottomRightPointsModule');
        ...
        const sideBottomLeftPoints  = require('src/SpaceSideBottomLeftPointsModule');
