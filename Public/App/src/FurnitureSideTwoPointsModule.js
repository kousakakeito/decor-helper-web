...
module.exports = function sideTwoPoints(stage,dots,rectangle,isMouseOnBorder,layer,dashedLine,drawDashedLine,midRect,furniturecenterInner,handleClick2){
  ...
  if( midRect.y() <= rectangle.y()){
    ...
    const  topTwoPoints  = require('src/FurnitureTopTwoPointsModule');
    const topTwoPoints2 = () =>{
    ...
    const  rightTwoPoints  = require('src/FurnitureRightTwoPointsModule');
    ...
    const  leftTwoPoints  = require('src/FurnitureLeftTwoPointsModule');
  ...
  const  bottomTwoPoints  = require('src/FurnitureBottomTwoPointsModule');
