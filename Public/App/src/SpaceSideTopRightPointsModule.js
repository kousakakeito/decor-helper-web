...
module.exports = function sideTopRightPoints(stage,dots,rectangle,isMouseOnBorder,layer,dashedLine,drawDashedLine,midRect,spacecenterInner,handleClick2){
  ...
  document.querySelector(".rectAngle-SizeForm12").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  document.querySelector(".rectAngle-SizeForm13").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  document.querySelector(".rectAngle-SizeForm14").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  document.querySelector(".rectAngle-SizeForm15").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  ...
  function handleConfirm7(){
    ...
    if (dots[0].y() === rectangle.y() && dots[1].x() === rectangle.x() + rectangle.width()) {
      ...
      const  firstRightNextTopPoints  = require('src/SpaceFirstRightNextTopPointsModule');
  ...
  const  firstTopNextRightPoints  = require('src/SpaceFirstTopNextRightPointsModule');
