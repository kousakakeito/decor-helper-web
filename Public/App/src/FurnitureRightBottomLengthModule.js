...
if(check[0].checked){
  ...
  const  rightBottomCheckTriangle  = require('src/FurnitureRightBottomCheckTriangleModule');
  ...
  const  rightBottomCheckSquare  = require('src/FurnitureRightBottomCheckSquareModule');
