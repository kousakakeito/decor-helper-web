...
if(check[0].checked){
  ...
  const  bottomLeftCheckTriangle  = require('src/FurnitureBottomLeftCheckTriangleModule');
  ...
  const  bottomLeftCheckSquare  = require('src/FurnitureBottomLeftCheckSquareModule');
