...
module.exports = function leftTwoPoints(stage,dots,rectangle,isMouseOnBorder,layer,dashedLine,drawDashedLine,midRect,spacecenterInner,handleClick2,handleConfirm2,length){
  ...
  document.querySelector(".rectAngle-SizeForm8").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  document.querySelector(".rectAngle-SizeForm9").addEventListener('input', function(e) {
    this.value = this.value.replace(/[^0-9]/g, '');
  });
  ...
  while (document.querySelector(".div3").lastChild) {
   ...
   function handleConfirm5(){
    ...
    if(size2 !== "" && size3 === ""){
      ...
      const  leftTopLength  = require('src/SpaceLeftTopLengthModule');
      ...
      const  leftBottomLength  = require('src/SpaceLeftBottomLengthModule');
