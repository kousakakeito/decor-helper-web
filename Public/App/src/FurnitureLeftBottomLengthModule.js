...
if(check[0].checked){
  ...
  const  leftBottomCheckTriangle  = require('src/FurnitureLeftBottomCheckTriangleModule');
  ...
  const  leftBottomCheckSquare  = require('src/FurnitureLeftBottomCheckSquareModule');
